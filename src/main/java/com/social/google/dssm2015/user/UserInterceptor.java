...
/**
 * Before a request is handled: 1. sets the current User in the {@link SecurityContext} from a cookie, if present and the user is still connected to Facebook. 2. requires that the user sign-in if he
